...
//               <div className="testpage-detailed-results">
//                 <div className="testpage-result-category testpage-correct">
//                   <span>✅ Correct: {result?.score}</span>
//                 </div>
//                 <div className="testpage-result-category testpage-incorrect">
//                   <span>
//                     ❌ Incorrect: {test?.questions.length - result?.score}
//                   </span>
//                 </div>
//               </div>
